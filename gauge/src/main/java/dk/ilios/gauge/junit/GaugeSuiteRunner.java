...
// */
//public class GaugeSuiteRunner extends ParentRunner<FrameworkMethod> {
//
...
//     */
//    public GaugeSuiteRunner(Class<?> klass) throws InitializationError {
//        super(klass);
//    }
//
//    @Override
...
//        //        Gauge.runBenchmarks(testClass.getJavaClass(), testMethods, new Gauge.Callback() {
////
...
//        }
//
//        List<FrameworkMethod> benchmarkMethods = testClass.getAnnotatedMethods(Benchmark.class);
//        for (FrameworkMethod method : benchmarkMethods) {
...
//    }
//
////    public GaugeSuiteRunner(Class clazz) {
