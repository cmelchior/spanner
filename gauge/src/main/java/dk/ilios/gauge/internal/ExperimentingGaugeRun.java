...
import dk.ilios.gauge.internal.trial.AndroidUnitTestTrial;
import dk.ilios.gauge.internal.trial.ScheduledTrial;
import dk.ilios.gauge.internal.trial.TrialContext;
import dk.ilios.gauge.model.BenchmarkSpec;
import dk.ilios.gauge.model.Host;
 ...
 */
public final class ExperimentingGaugeRun implements GaugeRun {

    private static final Logger logger = Logger.getLogger(ExperimentingGaugeRun.class.getName());
