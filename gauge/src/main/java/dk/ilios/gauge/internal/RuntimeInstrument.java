...
import static dk.ilios.gauge.util.Util.isStatic;
...
import dk.ilios.gauge.Macrobenchmark;
import dk.ilios.gauge.bridge.AbstractLogMessageVisitor;
import dk.ilios.gauge.bridge.GcLogMessage;
import dk.ilios.gauge.bridge.HotspotLogMessage;
...
import dk.ilios.gauge.internal.benchmark.BenchmarkMethods;
...
import dk.ilios.gauge.worker.MacrobenchmarkWorker;
import dk.ilios.gauge.worker.RuntimeWorker;
...
public class RuntimeInstrument extends Instrument {
    ...
    private class MacrobenchmarkInstrumentation extends Instrumentation {
        ...
        public void dryRun(Object benchmark) throws UserCodeException {
            ImmutableSet<Method> beforeRepMethods = getAnnotatedMethods(benchmarkMethod.getDeclaringClass(), BeforeRep.class);
            ImmutableSet<Method> afterRepMethods = getAnnotatedMethods(benchmarkMethod.getDeclaringClass(), AfterRep.class);
            try {
